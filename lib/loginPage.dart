      ...
      body: Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/images/purple3.jpg'),
              fit: BoxFit.cover,
            ),
          ),
            ...
            children: <Widget>[
              Padding(
                  ...
                  child: Text("Depression Detection",
                    style: TextStyle(fontSize: 50, fontFamily: 'ChakraPetch', color: Colors.purple.shade800),
              ...
              OutlineButton(
                child: Text(
                    "Sign In",
                    style: TextStyle(fontFamily: 'ChakraPetch', color: Colors.deepPurple),
                ),
